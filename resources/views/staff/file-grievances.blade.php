...
@section('sidebar')
  <!-- Profile button -->
  <a href="/staff/profile" class="flex items-center space-x-4 px-4 py-4 rounded-lg font-semibold text-gray-700 hover:bg-red-800 hover:text-white">
  ...
  <!-- File Grievances button - active state -->
...
<div class="px-3 -mt-4 mb-4">
  ...
  <div class="flex-1 max-w-[1300px] mx-auto w-full px-7">
    <!-- Form box -->
    <div class="bg-white rounded-2xl shadow-lg p-5 w-full max-h-[400px] overflow-y-auto">
      ...
      <form class="space-y-3 text-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <input type="text" id="school_id" name="school_id" placeholder="School ID"
                 class="w-full px-3 py-3 border border-gray-300 rounded focus:ring-2 focus:ring-red-800 focus:border-red-800 outline-none" />
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
          <input type="date" id="date" name="date"
                 class="w-full px-3 py-3 pr-10 border border-gray-300 rounded focus:ring-2 focus:ring-red-800 focus:border-red-800 outline-none" />
          <select id="grievance" name="grievance"
                  class="w-full px-3 py-3 pr-10 border border-gray-300 rounded focus:ring-2 focus:ring-red-800 focus:border-red-800 outline-none appearance-none bg-white">
        ...
        <textarea id="description" name="description" rows="5" placeholder="Description of Incident"
                  class="w-full px-3 py-3 border border-gray-300 rounded focus:ring-2 focus:ring-red-800 focus:border-red-800 outline-none resize-none"></textarea>

        <!-- Buttons -->
        <div class="flex justify-end space-x-3 pt-2">
          <button type="button"
                  class="px-4 py-2 border border-gray-300 text-gray-700 rounded hover:bg-gray-50 focus:ring-2 focus:ring-gray-500 focus:border-gray-500 outline-none">
            Clear
          </button>
          <button type="submit"
                  class="px-4 py-2 bg-red-900 text-white rounded hover:bg-red-800 focus:ring-2 focus:ring-red-800 outline-none">
            Add
          </button>
        </div>
      </form>
