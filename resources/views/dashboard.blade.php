...
@section('content')
      ...
      <div class="flex gap-8 mb-8 flex-shrink-0">
        ...
        <div class="w-96 bg-white rounded-2xl shadow-lg p-10 flex flex-col justify-between">
          ...
          <h4 class="font-semibold text-center text-lg mb-2">Rona Arbe B. Limbago</h4>
          <p class="text-base text-gray-600 text-center mb-4">Student</p>
          <div class="mb-6 text-sm text-gray-700 space-y-2">
            ...
            <p><span class="font-semibold">Status:</span> Good Moral Status</p>
          </div>
