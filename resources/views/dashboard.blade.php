...
<header class="flex items-center justify-between bg-white border-b border-gray-200 px-6 py-4">
  ...
  <div class="flex items-center space-x-4">
    ...
    <!-- Notifications (relative wrapper keeps dropdown anchored here) -->
    <div class="relative">
      <button id="btnNotifications"
              class="relative p-2 rounded-full hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-red-800"
     ...
     class="hidden absolute right-0 mt-2 w-72 bg-white shadow-lg rounded-lg border border-gray-200 z-50">
  <ul class="divide-y divide-gray-100">

    <li class="flex items-center gap-3 px-4 py-2 hover:bg-gray-50">
      <!-- Black Bulb Icon -->
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor"
           viewBox="0 0 24 24" class="w-5 h-5 text-gray-700 flex-shrink-0">
        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M12 3a7 7 0 0 0-7 7c0 2.39 1.2 4.48 3 5.73V17a2 2 0 0 0 2 2h4a2 
                 2 0 0 0 2-2v-1.27c1.8-1.25 3-3.34 3-5.73a7 7 0 0 0-7-7z"/>
      </svg>
      <span class="text-sm text-gray-800">New grievance submitted</span>
    </li>
    ...
    <li class="flex items-center gap-3 px-4 py-2 hover:bg-gray-50">
      ...
      <span class="text-sm text-gray-800">CASE-2025-003 resolved</span>
    </li>
    ...
    <li class="flex items-center gap-3 px-4 py-2 hover:bg-gray-50">
      ...
      <span class="text-sm text-gray-800">Hearing set for CASE-2025-001</span>
    </li>
    ...
    <li class="flex items-center gap-3 px-4 py-2 hover:bg-gray-50">
      ...
      <span class="text-sm text-gray-800">New message from Guidance</span>
    </li>
...
<aside class="w-80 bg-white border-r border-gray-200 flex flex-col">
  ...
  <nav class="flex-grow p-4 space-y-2">
    ...
    <!-- Dashboard -->
    <a href="#"
       class="flex items-center space-x-4 px-4 py-4 rounded-lg font-semibold text-gray-700 hover:bg-red-800 hover:text-white bg-red-800 text-white">
      <!-- Dashboard Icon -->
      <svg xmlns="http://www.w3.org/2000/svg" 
           fill="currentColor" 
           viewBox="0 0 24 24" 
 ...
 <div class="p-4 border-t border-gray-500 mt-auto">
    <a href="#"
       class="flex items-center space-x-4 px-4 py-4 rounded-lg font-semibold text-gray-600 hover:bg-red-900 hover:text-white">
      <!-- Logout Icon -->
      <svg xmlns="http://www.w3.org/2000/svg" 
           fill="currentColor" 
           viewBox="0 0 24 24" 
    ...
    <main class="flex-grow bg-white p-8">
      ...
      <!-- TOP CARD (ADJUSTAN PA)-->
      <div class="bg-[#6f0909] text-white rounded-xl flex items-center justify-between p-10 mb-10">
  ...
  class="h-40 object-contain">  
      ...
      <div class="grid grid-cols-3 gap-4 mb-8">
        <div class="bg-white rounded-2xl shadow p-8 text-center">
          <p class="text-5xl font-bold text-red-800">2</p>
          <p class="text-gray-600">Total Cases</p>
        </div>
        <div class="bg-white rounded-2xl shadow p-8 text-center">
          <p class="text-5xl font-bold text-yellow-500">1</p>
          <p class="text-gray-600">Active Cases</p>
        </div>
        <div class="bg-white rounded-2xl shadow p-8 text-center">
          <p class="text-5xl font-bold text-green-600">1</p>
      ...
      <div class="grid grid-cols-3 gap-8">
        ...
        <div class="bg-white rounded-2xl shadow p-6 text-center">
          <img src="images/avatar.png" alt="Profile" class="h-20 w-20 rounded-full mx-auto mb-4">
          <h4 class="font-semibold">Rona Arbe B. Limbago</h4>
...
<footer class="w-full text-center py-4 text-sm text-gray-600 border-t rounded-b-lg">
      <p>
        Copyright &copy; 2025 University of Southeastern Philippines. 
        All Rights Reserved |
